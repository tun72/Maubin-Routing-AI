        ...
        <div className={cn("flex flex-col gap-6")}>
            <Card className="overflow-hidden p-0">
                <CardContent className={`${type === "SIGN_IN" && "grid p-0 md:grid-cols-2"}`}>
                        ...
                        <form onSubmit={form.handleSubmit(handelSubmit)}
                            ...
                            <div className="flex flex-col gap-6">
                                <div className="flex flex-col items-center text-center">
                                    {type === "SIGN_IN" ? <h1 className="text-2xl font-bold">Welcome back</h1> : <h1 className="text-2xl font-bold">Welcome new User</h1>}
                                    <p className="text-muted-foreground text-balance">
                                        {type === "SIGN_IN" ?
                                            "Login to your  account" : "Signup to your account"}
                                    </p>
                                </div>

                                {Object.keys(defaultValues).map((fields) => (
                                    <div className="grif gap-3" key={fields}>
                                        <FormField
                    ...
                    {
                        !!(type === "SIGN_IN") && <div className="bg-muted relative hidden md:block">
                            <Image
                                src={login}
                                alt="Image"
