        ...
        <section id="contact" className="px-6 py-20">
            <div className="max-w-4xl mx-auto">
                <div className="text-center mb-16">
                    ...
                    <p className={`mt-4 text-lg ${customTheme.textSecondary}`}>We are here to help. Contact us for support, partnerships, or press inquiries.</p>
                </div>
                <div className={`grid md:grid-cols-2 gap-8 ${customTheme.cardBg} border ${customTheme.cardBorder} rounded-2xl p-8`}>
                    <div className="space-y-6">
                        <h3 className="text-2xl font-bold">Contact Information</h3>
                        <p className={customTheme.textSecondary}>Fill out the form or contact us directly. Our team will get back to you within 24 hours.</p>
                    ...
                    <form className="space-y-4">
                        <div className="relative">
                            ...
                            <input type="text" name="name" placeholder="Your Name" className={`w-full p-3 pl-10 rounded-lg ${customTheme.inputBg} border ${customTheme.inputBorder} focus:ring-2 focus:ring-sky-500 focus:outline-none transition-colors`} required />
                        </div>
                        <div className="relative">
                            <Mail className={`absolute top-1/2 -translate-y-1/2 left-3 w-5 h-5 ${customTheme.textSecondary}`} />
                            <input type="email" name="email" placeholder="Your Email" className={`w-full p-3 pl-10 rounded-lg ${customTheme.inputBg} border ${customTheme.inputBorder} focus:ring-2 focus:ring-sky-500 focus:outline-none transition-colors`} required />
                        </div>
                        <div className="relative">
